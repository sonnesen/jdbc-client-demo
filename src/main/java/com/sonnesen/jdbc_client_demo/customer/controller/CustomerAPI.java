...
public interface CustomerAPI {
    ...
    CustomerResponse findById(@Parameter(description = "Customer id") @PathVariable @Min(1) Long id);
    ...
    CustomerResponse update(@Parameter(description = "Customer id") @PathVariable @Min(1) Long id,
    ...
    void deleteById(@Parameter(description = "Customer id") @PathVariable @Min(1) Long id);
